<div x-data="{ sidebarOpen: true }" class="flex">
    <div class="w-64 h-screen fixed bg-white dark:bg-gray-900 text-white flex flex-col p-4 overflow-y-auto transition-transform duration-300 ease-in-out"
    ...
    <button @click="sidebarOpen = !sidebarOpen" class="fixed top-4 right-4 w-12 h-12 rounded-full bg-gray-800 text-white flex items-center justify-center shadow-lg z-50">

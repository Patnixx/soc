...
<div class="flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
    <form action="{{ route('events.store.vp', $courseid) }}" method="post" class="w-full max-w-xl bg-white dark:bg-gray-900 shadow-lg rounded-lg p-6 space-y-4 transition-all duration-300 ease-linear">
        @csrf

    ...
    <form action="{{route('users.update', $account->id)}}" method="POST" class="grid grid-cols-2 gap-6 mb-6">
        ...
        <div class="left">
            <div class="flex flex-col space-y-2 mb-2">
                ...
                <x-input-div :name="'f_name'" :type="'text'" :placeholder="''.$account->f_name.''" :id="'f_name'" :value="''.$account->f_name.''" :icon="'bi bi-1-circle-fill'"/> 
            </div>
            <div class="flex flex-col space-y-2 mb-2">
                <label for="l_name" class="text-sm font-medium dark:text-white text-gray-900">Last name</label>
                <x-input-div :name="'l_name'" :type="'text'" :placeholder="''.$account->l_name.''" :id="'l_name'" :value="''.$account->l_name.''" :icon="'bi bi-2-circle-fill'"/>
            </div>
            <div class="flex flex-col space-y-2 mb-2">
        ...
        <div class="right">
            <div class="flex flex-col space-y-2 mb-2">
                ...
                <x-input-div :name="'telephone'" :type="'tel'" :placeholder="'0123 456 789'" :id="'telephone'" :value="''.$account->tel_number.''" :icon="'bi bi-telephone'"/>
            </div>
            <div class="flex flex-col space-y-2 mb-2">
            ...
            <div class="flex flex-col space-y-2 mb-2">
                ...
                <x-input-div :name="'pass'" :type="'password'" :placeholder="'Password'" :id="'pass'" :value="''" :icon="'bi bi-hash'"/>
            </div>
            <div class="flex flex-col space-y-2 mb-2">

...
<div class="dark:bg-gray-800 bg-m-blue hover:bg-m-red dark:hover:bg-m-darkblue relative flex items-center justify-center sm:h-4 sm:w-4 md:w-6 md:h-6 lg:h-8 lg:w-8 xl:h-10 xl:w-10 2xl:h-12 2xl:w-12 mt-2 mb-2 mx-auto rounded-3xl hover:rounded-xl transition-all duration-300 ease-linear group cursor-default">

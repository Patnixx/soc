...
<div class="dark:bg-gray-800 bg-m-blue hover:bg-m-red dark:hover:bg-m-darkblue relative flex items-center justify-center h-12 w-12 mt-2 mb-2 mx-auto rounded-3xl hover:rounded-xl transition-all duration-300 ease-linear group cursor-default">
